  ...
  const projects = [
    {
      ...
      github: 'https://github.com/Habib-de/E-commerce',
    ...
    },
    {
      ...
      github: 'https://github.com/Habib-de/Hospital',
    ...
    },
    {
      ...
      github: 'https://github.com/Habib-de/Rock-Paper-and-Scissor-Game',
    ...
    },
    {
      ...
      github: 'https://github.com/Habib-de/taskflow',
    ...
    <section id="projects" className="py-20 bg-gradient-to-b from-gray-900 to-dark">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mt-12">
          <a
            href="https://github.com/Habib-de"
            target="_blank"
            rel="noopener noreferrer"
